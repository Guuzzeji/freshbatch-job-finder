...
export default function JobCard({ job }: { job: Job }) {
  ...
  return (
    <div className="motion-enter-pop motion-hover-lift motion-transition-subtle relative overflow-hidden rounded-2xl border border-[color:var(--border-light)] bg-white px-[1.15rem] py-4">
