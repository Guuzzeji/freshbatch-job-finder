...
const NAV_ITEMS: NavItem[] = [
  ...
  { kind: "link", label: "Delivery Log", href: "/docs/getting-started/delivery-log" },
  ...
  { kind: "link", label: "Python", href: "/docs/signature-verification/python" },
  { kind: "link", label: "TypeScript", href: "/docs/signature-verification/typescript" },
